...
print_r($datos);
$dbc = conexion();
// $query="SELECT CONCAT(participante.NombreParticipante,' ', participante.ApellidopParticipante,' ', participante.ApellidomParticipante) AS NOMBRE, evento.NombreEvento 
// FROM participante, evento WHERE IdEvento=$id;";
